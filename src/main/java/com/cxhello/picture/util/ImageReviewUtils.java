...
public class ImageReviewUtils {
    ...
    @Value("${aliyun.content.regionId}")
    private String regionId;

    @Value("${aliyun.content.accessKeyId}")
    private String accessKeyId;

    @Value("${aliyun.content.accessKeySecret}")
    private String accessKeySecret;

    public void review(List<String> urlList) {
        IClientProfile profile = DefaultProfile.getProfile(regionId, accessKeyId, accessKeySecret);
        DefaultProfile.addEndpoint(regionId, "Green", "green.cn-beijing.aliyuncs.com");
         ...
         */
        List<JSONObject> taskList = new ArrayList<>(urlList.size());
